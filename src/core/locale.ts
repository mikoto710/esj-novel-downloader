...
export const ZH_CN_MESSAGES = Object.freeze({
    ...
    "mapping.detected.message": "该章节使用专属映射字体。继续下载后只能导出 HTML 或 EPUB；复制、搜索和朗读可能不正确，缓存及导出文件也会明显增大。",
    "mapping.detected.summary": "当前检测到 {count} 章，字体 {bytes}。",
    "mapping.detected.inflight": "已停止领取新章节。已经发出的请求仍会收尾，进度最多还可能增加 {count} 章；这不表示任务仍在继续领取章节。",
    ...
    "mapping.export.message": "将嵌入 {count} 个章节字体，共 {bytes}。{format} 只能保证视觉显示，复制、搜索和朗读可能不正确。",
    ...
    "export.mappingWarning": "⚠️ 检测到 {count} 个映射章节，字体共 {bytes}。TXT 已禁用；HTML/EPUB 仅保证视觉显示，复制、搜索和朗读可能不正确。",
    ...
    "diagnostics.reason.superseded": "随后已有同一本书的全本任务进入下载流程；此旧会话不再视为进行中，原始结果仍未确认。",
    "diagnostics.reason.interrupted": "页面关闭后超过 30 分钟仍未收到终态回执。此为诊断视图判断，不会改变下载、缓存或取消状态。",
    ...
    "diagnostics.privacy": "诊断文件包含作品名称、作品链接和失败章节信息，但不包含小说正文、登录凭据、图片或字体内容。请确认后再公开分享。",
...
export const ZH_TW_MESSAGES = Object.freeze({
    ...
    "mapping.detected.message": "該章節使用專屬映射字型。繼續下載後只能匯出 HTML 或 EPUB；複製、搜尋和朗讀可能不正確，快取及匯出檔案也會明顯增大。",
    "mapping.detected.summary": "目前偵測到 {count} 章，字型 {bytes}。",
    "mapping.detected.inflight": "已停止領取新章節。已經送出的要求仍會收尾，進度最多還可能增加 {count} 章；這不表示任務仍在繼續領取章節。",
    ...
    "mapping.export.message": "將嵌入 {count} 個章節字型，共 {bytes}。{format} 只能保證視覺顯示，複製、搜尋和朗讀可能不正確。",
    "mapping.export.back": "返回",
    ...
    "export.chapterCount": "共 {count} 章",
    "export.mappingWarning": "⚠️ 偵測到 {count} 個映射章節，字型共 {bytes}。TXT 已停用；HTML/EPUB 僅保證視覺顯示，複製、搜尋和朗讀可能不正確。",
    ...
    "diagnostics.reason.superseded": "隨後已有同一本書的全本任務進入下載流程；此舊工作階段不再視為進行中，原始結果仍未確認。",
    "diagnostics.reason.interrupted": "頁面關閉後超過 30 分鐘仍未收到終態回執。此為診斷檢視判斷，不會改變下載、快取或取消狀態。",
    "diagnostics.action.download": "下載診斷日誌",
    "diagnostics.action.copy": "複製摘要",
    "diagnostics.action.clearAll": "清除全部",
    "diagnostics.action.delete": "刪除記錄",
    "diagnostics.empty": "暫無記錄",
    "diagnostics.privacy": "診斷檔案包含作品名稱、作品連結和失敗章節資訊，但不包含小說正文、登入憑證、圖片或字型內容。請確認後再公開分享。",
