...
export const LOCALE_KEYS = [
    ...
    "range.invalid",
    "range.allEquivalent",
    "range.cacheDiscardWarning",
    "range.stopClearWarning",
    "range.openPrevious",
    "range.download",
    "range.replace.title",
    "range.replace.message",
    "range.replace.continue",
    ...
    "mapping.error.structureInvalid",
    "mapping.error.cssInvalid",
    "mapping.error.fontSourceInvalid",
    "mapping.error.fontTooLarge",
    "mapping.error.woff2Invalid",
    "mapping.error.hashMismatch",
    ...
    "export.log.buildHtml",
    "export.log.buildEpub",
    ...
    "history.chapter.total",
    "history.chapter.withMissing",
    "history.chapter.range",
    "history.chapter.rangeWithMissing",
    ...
    "diagnostics.summary.versionUnknown",
    "diagnostics.summary.browserVersionUnknown",
    "diagnostics.summary.unknownBook",
    "diagnostics.summary.book",
    "diagnostics.summary.link",
    "diagnostics.summary.range",
    ...
    "diagnostics.summary.logs",
    "diagnostics.summary.failures",
    "diagnostics.summary.none",
    "diagnostics.failure.invalidImageUrl",
    "diagnostics.failure.imageFormatUnrecognized",
    "diagnostics.failure.imageProcessingFailed",
    "diagnostics.failure.imageRequestFailed",
    ...
    "download.missing.rangePosition",
