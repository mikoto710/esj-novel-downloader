...
description: Implement, refactor, or diagnose ESJ Novel Downloader TypeScript userscript changes while preserving its scraper/UI, download-core, browser-adapter, cache, and export boundaries. Use for feature work, bug fixes, refactors, or code review in this repository, especially changes involving downloads, cancellation, IndexedDB cache migration, browser APIs, exports, mapping fonts, or page UI.
---
